#!/usr/bin/env python
"""
GUI application entry point for the STITCH Linkage Tool.
...
def get_log_file():
    ...
    return Path.home() / ".STITCH-linkage-tool.log"
...
def log_error(error_msg, exception=None):
    ...
    try:
        ...
        with open(log_file, "a", encoding="utf-8") as f:
            f.write(f"\n{'='*70}\n")
            f.write(f"[{timestamp}] STITCH Linkage Tool Error\n")
            f.write(f"{'='*70}\n")
            f.write(f"{error_msg}\n")
...
def main():
    ...
    try:
        ...
        error_msg = f"Failed to start STITCH Linkage Tool GUI: {str(e)}"
        ...
        try:
            ...
            msg.setText("STITCH Linkage Tool failed to start")
